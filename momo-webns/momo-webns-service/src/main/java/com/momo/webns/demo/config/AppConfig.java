...
import com.momo.webns.demo.config.service.impl.InventoryServiceImpl;
import com.momo.webns.demo.config.service.impl.OrderServiceImpl;

@Configuration
//@Import(DataConfig.class)
//@PropertySource("classpath:/application-${spring.profiles.active}.properties")
@ComponentScan(basePackages = {"com.momo.webns.demo"})
